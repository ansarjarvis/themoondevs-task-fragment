...
import { useWallet, useAppSupplies, useAppToast, useChainSelector } from "...";
import useBurnTransactions from "../after/hooks/use-burn-transaction";

const BurnPageStyled = styled.div`
  // our styled-component will be here
`;
...
export const BurnPage = () => {
  ...
  // Handle change in the burn  input
  ...
  const handleExecuteBurn = async () => {
    ...
    fetchBurnTransactions(); // to refetch after burning
  };
            ...
            <div className="info_box filled">
              ...
              <BurnButtonBar>
                ...
                <div className="description medium">
                  ...
                  permanently removing a certain number of them from
                  circulation, often through a deliberate and recorded
                  mechanism. &quot;
                </div>
            ...
            <BurnStatsContainer>
              ...
              <div className="supply_bar">
                ...
                <span
                  ...
                  style={{
                    width: `${100 - statsSupplies.circulatingPercent}%`,
                  }}
                ></span>
                <span
              ...
              <div className="supply_label_list">
                <div>
                  ...
                  <p className="supply_value">
                    ...
                    />
                    {numberWithCommas(
                      statsSupplies.totalSupply -
                        statsSupplies.circulatingSupply
                    )}
                  </p>
